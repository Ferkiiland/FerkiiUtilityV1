...
echo.         
echo.                                             
echo.                                                            Escribe "X" para ir al menu
echo.                                                              
echo.                  "============================================================================================================="
...
echo.                "==================================================================================================================="								
echo.                                                          
echo.                                                         STEVEN-MODIFICACIONES BLUESTACKS Y WINDOWS
echo.                             
echo.                "==================================================================================================================="
echo.                                                                                
...
echo.                                  
echo.                                       [22] Usb Ajuste             [23] Msi                 [24] Ping Checker
echo.                                                                      
...
:tutorial
powershell -Command "& {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('Tutorial when full version, just read all warnings and popups and you will be good', 'Exm Tweaking Utility', 'OK', [System.Windows.Forms.MessageBoxIcon]::Information);}"
...
:intel
powershell -Command "& {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('Only do this if you have an intel gpu', 'Exm Tweaking Utility', 'OK', [System.Windows.Forms.MessageBoxIcon]::Information);}"
echo.
echo.
echo.
echo.
...
echo.                                                                                                                                                                       
echo.                                                                                                                    
echo.                                        [1] Optimizar Ajustes Windows     [2] Disable useless features
echo.
...
:device
powershell -Command "& {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('Click on devices, select "select all" and "remove selected"', 'Exm Tweaking Utility', 'OK', [System.Windows.Forms.MessageBoxIcon]::Information);}"

C:\Exm\Res\DeviceCleaner.exe
echo.
echo.
echo                                                        Press any key to continue...     
pause >nul
...
echo.
echo.                                                   [3] Uninstall Apps      [4] Coming soon!             
echo.                                                                                                                    
echo.                                                                                                                   
echo.                                                          Type "X" to go back to menu
echo.                                                              
...
:windebloat
powershell -Command "& {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('Uninstall all apps that you dont need, there is a bunch off useless apps like xbox, windows tips...', 'Exm Tweaking Utility', 'OK', [System.Windows.Forms.MessageBoxIcon]::Information);}"
C:\Exm\Shortcuts\Uninstall_Apps_You_Dont_Need.lnk
echo.
echo.
echo                                                        Press any key to continue...     
pause >nul
...
echo.
powershell -Command "& {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('Click on ADJUST FOR BEST PERFORMANCE, And select SHOW THUMBNAILS INSTEAD OF ICONS and SMOOTH EDGES ON SCREEN FONTS', 'Exm Tweaking Utility', 'OK', [System.Windows.Forms.MessageBoxIcon]::Information);}"
...
echo.
echo.                                             [3] Nvidia Profile Inspector      [4] Disable P-State
echo.                                                                                                               
echo.                                                                                                                  
echo.                                                            Type "X" to go back to menu                                   
echo.                                                                                                                  
...
:install
powershell -Command "& {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('Best Driver Rn - 522.25 (note: installing a new driver will give fps drops for a lil bit, it will fix if you play a couple games )', 'Exm Tweaking Utility', 'OK', [System.Windows.Forms.MessageBoxIcon]::Information);}"

C:\Exm\Res\NVCleanstall.exe
echo.
echo.                                                        Press any key to continue...     
pause >nul
cls
...
:nvpi
powershell -Command "& {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('Drag The file over the app', 'Exm Tweaking Utility', 'OK', [System.Windows.Forms.MessageBoxIcon]::Information);}"

start C:\Exm\NvProfile
C:\Exm\Res\NvidiaProfileInspector.exe
echo.
echo.                                                        Press any key to continue...     
pause >nul
cls
...
:msi
powershell -Command "& {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('Make sure your gpu is set on MSI mode, and priority is on high', 'Exm Tweaking Utility', 'OK', [System.Windows.Forms.MessageBoxIcon]::Information);}"

C:\Exm\Res\MSI_Utility_V3.exe
...
echo.
powershell -Command "& {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('Click on "optimize/defragment" to optimize your drives', 'Exm Tweaking Utility', 'OK', [System.Windows.Forms.MessageBoxIcon]::Information);}"
...
echo.                                                                                                                  
echo.                                                                                                                    
echo.                                         [1] Power Plan     [2] Power Tweaks    [3] Advanced Cpu Power Tweaks               				                  
echo.
echo.                              
echo.                                                         Press "X" to go back to menu                                                                                                                                                       
echo.                                                                                                                  
...
powercfg -import "C:\Exm\PowerPlan\ExmPremiumPowerPlan.pow"
...
:filter 
powershell -Command "& {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('Best settings: Ignore under - 0, Repeat Delay - 250, Repeat Rate - 40, Select: Save to registry, On and click on ok/apply', 'Exm Tweaking Utility', 'OK', [System.Windows.Forms.MessageBoxIcon]::Information);}"

C:\Exm\Res\FilterKeysSetter.exe
echo.
echo.
echo                                                        Press any key to continue...     
pause >nul
